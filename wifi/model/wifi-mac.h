...
class WifiMac : public Object
{
  public:
    ...
    /**
    * @brief Notify the packet being forwarded to the openflow pipeline
    *
    * @param packet
    */
    void NotifyOpenFlowRx (Ptr<const Packet> packet);
    void NotifyOpenFlowNormalAction (Ptr<const Packet> packet);
    void NotifyBroadcastTx(Ptr<const Packet> packet);
  ...
  private:
    ...
    /**
     * @brief The trace source fired for packets successfully received by the device
     * immediately before being forwarded do the openflow pipeline
     *
     */
    TracedCallback<Ptr<const Packet> >  m_macOpenFlowRxTrace;
    TracedCallback<Ptr<const Packet> >  m_macOpenFlowNormalTrace;
    TracedCallback<Ptr<const Packet> >  m_macBroadcastTxTrace;
