    ...
    static TypeId tid =
        TypeId("ns3::WifiMac")
            ...
            .AddTraceSource("MacRxDrop",
                            ...
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("MacOpenFlowRx",
                            "A packet has been received by this device, has been passed up from "
                            "the physical layer "
                            "and is being forwarded to the openflow pipeline. ",
                            MakeTraceSourceAccessor(&WifiMac::m_macOpenFlowRxTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("MacOpenFlowNormalAction",
                            "A packet has been received by this device, has been passed up from "
                            "the physical layer "
                            "and is being forwarded to the openflow pipeline. ",
                            MakeTraceSourceAccessor(&WifiMac::m_macOpenFlowNormalTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("MacBroadcastTx",
                            "A packet has been received by this device, has been passed up from "
                            "the physical layer "
                            "and is being forwarded to the openflow pipeline. ",
                            MakeTraceSourceAccessor(&WifiMac::m_macBroadcastTxTrace),
                            "ns3::Packet::TracedCallback")
...
// ------ NEW -----
void
WifiMac::NotifyOpenFlowRx(Ptr<const Packet> packet)
{
    m_macOpenFlowRxTrace(packet);
}

void
WifiMac::NotifyOpenFlowNormalAction(Ptr<const Packet> packet)
{
    m_macOpenFlowNormalTrace(packet);
}

void
WifiMac::NotifyBroadcastTx(Ptr<const Packet> packet)
{
    m_macBroadcastTxTrace(packet);
}
