...
- Sousa, D., Sargento, S., Luís, M., ``A simulation environment for software defined wireless networks with legacy devices,'' in Proceedings of the 18th ACM International Symposium on \ac{qos} and Security for Wireless and Mobile Networks, pp. 1–10, 2022.
...
- Sousa, D., Sargento, S., Luís, M., ``ATLAS, an Adaptive Multipath Routing for \ac{qos} Provisioning in Heterogeneous Software Defined Emergency Wireless Networks'', submitted to Ad Hoc Networks (Elsevier).
