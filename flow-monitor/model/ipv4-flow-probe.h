...
class Ipv4FlowProbe : public FlowProbe
{
  public:
    ...
    // inline std::ostream& operator<<(std::ostream& os, const DropReason& reason)
    // {
    //     switch (reason)
    //     {
    //     case DROP_NO_ROUTE:
    //         return (os << "DROP_NO_ROUTE");
    //     case DROP_TTL_EXPIRE:
    //         return (os << "DROP_TTL_EXPIRE");
    //     case DROP_BAD_CHECKSUM:
    //         return (os << "DROP_BAD_CHECKSUM");
    //     case DROP_QUEUE:
    //         return (os << "DROP_QUEUE");
    //     case DROP_QUEUE_DISC:
    //         return (os << "DROP_QUEUE_DISC");
    //     case DROP_INTERFACE_DOWN:
    //         return (os << "DROP_INTERFACE_DOWN");
    //     case DROP_ROUTE_ERROR:
    //         return (os << "DROP_ROUTE_ERROR");
    //     case DROP_FRAGMENT_TIMEOUT:
    //         return (os << "DROP_FRAGMENT_TIMEOUT");
    //     case DROP_INVALID_REASON:
    //         return (os << "DROP_INVALID_REASON");
    //     default:
    //         return (os << "UNKNOWN");
    //     }
    // }
