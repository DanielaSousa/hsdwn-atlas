...
#ifndef OFPP_SIMPLE_CONTROLLER_H
#define OFPP_SIMPLE_CONTROLLER_H
 ...
 */
class OfppSimpleController : public OFSwitch13Controller
{
  public:
    OfppSimpleController();           //!< Default constructor
    ~OfppSimpleController() override; //!< Dummy destructor.
