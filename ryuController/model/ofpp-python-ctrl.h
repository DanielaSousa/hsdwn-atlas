...
#ifndef OFPP_PYTHON_CONTROLLER_H
#define OFPP_PYTHON_CONTROLLER_H
 ...
 */
class OfppPythonController : public OFSwitch13Controller
{
  public:
    OfppPythonController(std::string abspath = ""); //!< Default constructor
    ~OfppPythonController() override;               //!< Dummy destructor.
