...
/**
   ...
   * @param list The routing Helper attached to the swNode
   * @return Ptr<OFSwitch13Device> The OpenFlow device created.
   */
  Ptr<OFSwitch13Device> InstallSwitch (Ptr<Node> swNode, NetDeviceContainer &swPorts, Ipv4ListRoutingHelper &list);
   ...
   * @return Ptr<OFSwitch13Device> The OpenFlow device created.
   */
  Ptr<OFSwitch13Device> InstallSwitch (Ptr<Node> swNode, Ipv4ListRoutingHelper &list);
     ...
     */
    static void SetAddressBase(Ipv4Address network,
                               Ipv4Mask mask,
